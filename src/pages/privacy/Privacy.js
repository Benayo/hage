...
const PrivacyPage = () => {
  return (
    <>
      <main className="mb-6 md:mb-[4.5rem] flex flex-col justify-center items-center  px-4 py-4 md:px-16">
        <div className="xl:w-[70%]">
          <div className="min-h-screen bg-gray-50 px-2 xl:px-8 text-gray-800 font-sans">
