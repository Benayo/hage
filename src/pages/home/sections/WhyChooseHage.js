    ...
    <div className="bg-white-200 px-4 md:px-16">
          ...
          <div>
            ...
            <div className="pb-5 text-sm md:text-base leading-6 text-left">
              ...
              <p className="pb-2 text-sm md:text-base leading-6 md:leading-8 font-body font-normal">
                ...
                traditional supply chains. Our innovative SaaS solution empowers
                businesses like Tunde's and manufacturing companies to work
                together seamlessly.
              </p>
              <p className="text-sm md:text-base leading-6 md:leading-8 font-body font-normal">
      ...
      <div className="py-8 md:py-28">
        <div className="grid md:grid-cols-2 gap-y-8 md:gap-y-0 md:gap-x-20 text-primary-300 pb-10 md:pb-20">
          <div className="order-2 md:order-1">
            <div className="pb-12 text-sm md:text-base leading-6 text-left">
              ...
              <p className="text-sm md:text-base leading-6 md:leading-8 font-body font-normal">
                ...
                transparency and collaboration, empowering businesses to deliver
                success.
              </p>
            </div>
            <div className="pb-5 text-sm md:text-base leading-6 text-left">
              ...
              <p className="text-sm md:text-base leading-6 md:leading-8 font-body font-normal">
                We envision a future where logistics operate seamlessly, fueled
                by real-time data and a shared view of the supply chain. Every
          ...
          <div className="flex flex-col justify-center order-1 md:order-2 text-right md:text-left">
            <h3 className="pb-2 md:pb-6 text-sm md:text-base leading-6  font-semibold">
              About us
            </h3>
            <h1 className=" font-main font-normal text-2xl md:text-5xl leading-9 md:leading-tight">
