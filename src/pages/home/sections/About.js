...
const About = () => {
  return (
    <div className="bg-white-200 px-4 md:px-20 py-8 md:py-16">
          <div className="grid md:grid-cols-2 gap-y-8 md:gap-y-0 md:gap-x-20 text-primary-300 pb-10 md:pb-20">
            ...
            <div className="flex flex-col justify-between order-1 md:order-2 text-right md:text-left">
              <h3 className="pb-2 text-sm md:text-base leading-6  font-semibold">
                About us
              </h3>
              <h1 className=" font-main font-normal text-2xl md:text-5xl leading-9 md:leading-tight">
                Hage is increasing transparency and ensuring effective
                communication from order to delivery
              </h1>
            </div>
          </div>
