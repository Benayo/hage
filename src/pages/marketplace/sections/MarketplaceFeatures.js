...
const MarketplaceFeatures = () => {
  return (
    <div className="bg-white-100 pt-5 md:pt-8">
      <div className="px-4 md:px-24">
        <div className="grid  md:grid-cols-2 ">
          <div className=" flex justify-center items-center">
            <div>
            <div className="mb-6"><span className="border-2 border-secondary-200 py-2 px-6 rounded-3xl text-secondary-200">V1 Coming soon</span></div>
        ...
        <div className=" py-8 md:py-16">
          ...
          <div className="flex flex-col justify-center items-center py-8 md:pt-20">
            <div className="mb-6"><span className="border-2 border-secondary-200 py-2 px-6 rounded-3xl text-secondary-200">V1 Coming soon</span></div>
